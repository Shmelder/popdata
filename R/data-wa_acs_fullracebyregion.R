#' Estimates of Washington race region joint distribution.
#'
...
#' @docType data
#' @keywords datasets
#' @format A dataset with each row being a region and race, and the columns are
...
#' @name wa_acs_fullracebyregion
"wa_acs_fullracebyregion"
